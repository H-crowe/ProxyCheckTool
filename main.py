...
def print_welcome_message():
    ...
    ascii_name = pyfiglet.figlet_format("Hossam", font="slant")
    print(Fore.YELLOW + Style.BRIGHT + ascii_name)
    
    print(Fore.CYAN + Style.BRIGHT + "=============================")
    print(Fore.CYAN + Style.BRIGHT + "     Enjoy the Proxy Testing!    ")
    print(Fore.CYAN + Style.BRIGHT + "=" * 50)
...
if __name__ == "__main__":
    ...
    if not proxies:
        logging.info("No proxies to test.")
        exit()
